This is the sqlite3 pkg source code. I cross compiled it to use on my Nexus 6 running 7.1.1. You must cross compile with the pie flags. 
...
NOTE: pie flasg are needed on systems where position independent executables are only supported.
